...
#     ], 
#     "Imprecision": [
#         st.Page("imprecision.py")
#     ],
#     "Method Comparison": [
#         st.Page("method_comparison.py", title="Overview"), 
#         st.Page("method_comparison/bland_altman.py", title="Bland-Altman Analysis")
#         st.Page()
#     ]
...
# Imprecision
imprecision_page = st.Page("imprecision.py", title="Imprecision Analysis")
# Statistical tests
stats_overview_page = st.Page("stats_tests/overview_stats.py", title="Overview")
anderson_darling_page = st.Page("stats_tests/anderson_darling.py", title="Anderson Darling")
bartlett_page = st.Page("stats_tests/bartlett_test.py", title="Bartlett Test")
...
levene_page = st.Page("stats_tests/levene_test.py", title="Levenes Test")
...
# Limits
limits_page = st.Page("limits.py", title="Limits")
# Reference Intervals
reference_intervals_page = st.Page("reference_intervals.py", title="Reference Interval Calculator")
...
pg = st.navigation({
    ...
    "Statistical Tests": [stats_overview_page, anderson_darling_page, 
